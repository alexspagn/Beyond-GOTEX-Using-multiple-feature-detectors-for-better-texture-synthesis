...
parser.add_argument('-nmax', '--n_iter_max', type=int, default=1000, help="max iterations of the algorithm(default: 500)")
...
synth_img = wgenpatex.GotexVggTextureSynthesis(args)
